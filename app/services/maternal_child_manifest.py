"""Maternal-Child module architecture manifest and build status."""
from __future__ import annotations

from typing import Any

from app.services.content_loader import load_content
from app.services.maternal_child_service import get_module_summary

MANIFEST_FILE = "maternal_child_manifest.json"
