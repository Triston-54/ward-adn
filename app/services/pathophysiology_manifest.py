"""Pathophysiology module architecture manifest and build status."""
from __future__ import annotations

from typing import Any

from app.services.content_loader import load_content
from app.services.pathophysiology_service import get_module_summary

MANIFEST_FILE = "pathophysiology_manifest.json"
