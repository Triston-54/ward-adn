...
def build() -> dict[str, Any]:
    ...
    return {
        ...
        "microbe_classification": [
            {"type": "Bacteria", "cell_type": "Prokaryote", "notes": "Most treatable with antibiotics; Gram stain guides empiric therapy.", "examples": ["S. aureus", "E. coli", "M. tuberculosis"]},
            {"type": "Viruses", "cell_type": "Acellular", "notes": "Require host cell; antivirals limited; vaccines prevent many.", "examples": ["Influenza", "HIV", "Norovirus"]},
            {"type": "Fungi", "cell_type": "Eukaryote", "notes": "Antifungals needed; opportunistic in immunocompromised.", "examples": ["Candida", "Aspergillus", "C. auris"]},
            {"type": "Parasites", "cell_type": "Eukaryote", "notes": "Protozoa and helminths; travel and sanitation relevant.", "examples": ["Giardia", "Plasmodium"]},
            {"type": "Prions", "cell_type": "Proteinaceous infectious particle", "notes": "No routine sterilization in community settings; CJD precautions for neuro tissue.", "examples": ["CJD"]},
        ],
